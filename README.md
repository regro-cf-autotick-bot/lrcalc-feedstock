...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/lrcalc-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/lrcalc-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add lrcalc python-lrcalc
# for installing globally
pixi global install lrcalc python-lrcalc
```
...
It is possible to list all of the versions of `lrcalc` available on your platform:
...
```
pixi search lrcalc --channel conda-forge
```
